            ...
            <div class="col-12">
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col">
                        ...
                        <a href="#" type="button" class="btn mb-2 btn-outline-success"><span class="fe fe-twitter fe-32"></span></a>
                    </div>
                    <div class="col text-center" style="margin-top: 20px;">
                        <span style="font-size: 25px; font-weight: bold;">TWITTER ANALYSIS FOR NIGER NORTH(Zone C)</span>
                    </div>
                                    ...
                                    <div class="list-group list-group-flush my-n3">
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-5">
                                                    <p class="small mb-0"><strong>Shehu mohammed Abdulahi</strong></p>
                                                    <small>
                                                        <a href="profile-posts.html" class="avatar avatar-sm">
                                        ...
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                <div class="col-2">
                                                    <a href="profile-posts.html" class="avatar avatar-sm">
                                                        <img src="{{asset('assets/images/nnpp.jpg')}}" alt="..." class="avatar-img rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col-5">
                                                    <p class="small mb-0"><strong>Wali ibrahim</strong></p>
                                                    <small>
                                                        <a href="profile-posts.html" class="avatar avatar-sm">
                                        ...
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-5">
                                                    <p class="small mb-0"><strong>Sani Bello Abubakar</strong></p>
                                                    <small>
                                                        <a href="profile-posts.html" class="avatar avatar-sm">
                                                            <!-- <img src="{{asset('assets/images/pdp.png')}}" alt="..." class="avatar-img rounded-circle"> -->
                                                        </a>
                                        ...
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                <div class="col-2">
                                                    <a href="profile-posts.html" class="avatar avatar-sm">
                                                        <img src="{{asset('assets/images/apga.jpg')}}" alt="..." class="avatar-img rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col-5">
                                                    <p class="small mb-0"><strong>Sani wushishi Sule</strong></p>
                                                    <small>
                                                        <a href="profile-posts.html" class="avatar avatar-sm">
                                                            <!-- <img src="{{asset('assets/images/apga.jpg')}}" alt="..." class="avatar-img rounded-circle"> -->
                                                        </a>
                                                ...
                                                <div class="col-5">
                                                    <h3 class="card-title mb-0 text-right counter-count">497</h3>
                                                    <p class="small text-muted mb-0 text-right">
                                                        <span class="fe fe-arrow-up fe-12 text-success"></span>
                                                        <span>+0.4%</span>
                                                    </p>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card shadow">
                                ...
                                <div class="card-body my-n2">
                                    ...
                                    <div id="sentimentByCandidateChart-4" style="height: 332px;"></div>
                                </div>
                            </div>
                        </div> <!-- Striped rows -->
                        <div class="col-md-12 col-lg-4">
                            <div class="card shadow eq-card mb-4">
                                ...
                                <div class="card-body">
                                    <div id="mostPopularHashtag-4"></div>
                                </div> <!-- .card-body -->
                            </div> <!-- .card -->
                        </div> <!-- .col -->
                        <!-- <div class="col-md-12 col-lg-4">
                            ...
                            <div class="card shadow eq-card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-widget mb-2 mr-2">
                                        <div id="dailyTweet-4" style="padding: 10px;"></div>
                                    </div>
                                </div> <!-- .card-body -->
                            </div> <!-- .card -->
                        </div> <!-- .col -->
