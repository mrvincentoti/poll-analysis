        ...
        <div class="row">
            <div class="col-md-12 col-lg-4">
                <div class="card shadow eq-card timeline">
                    ...
                    <div class="card-body" data-simplebar="init" style="height: 540px; overflow-y: auto; overflow-x: hidden;">
            ...
            <div class="col-md-12 col-lg-8">
                <div class="col-md-12 mb-4">
                    <div class="card shadow">
                        <div class="card-header">
                            <strong class="card-title mb-0">Tweets Analysis Per Region</strong>
                        ...
                        <div class="card-body">
                            <canvas id="barChartjsRegion" width="400" height="300"></canvas>
                        </div> <!-- /.card-body -->
                    </div> <!-- /.card -->
                </div> <!-- /. col -->
            </div>
