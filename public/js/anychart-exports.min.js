        ...
        _.exports = 1; (function ($) {
            ...
            bia = function (a, b) {
                var c = []; if ($.Aa(b, a)) c.push("[...circular reference...]"); else if (a && 50 > b.length) {
                    c.push(aia(a) + "("); for (var d = a.arguments, e = 0; d && e < d.length; e++) { 0 < e && c.push(", "); var f = d[e]; switch (typeof f) { case "object": f = f ? "object" : "null"; break; case "string": break; case "number": f = String(f); break; case "boolean": f = f ? "true" : "false"; break; case "function": f = (f = aia(f)) ? f : "[fn]"; break; default: f = typeof f }40 < f.length && (f = f.substr(0, 40) + "..."); c.push(f) } b.push(a); c.push(")\n"); try {
                        c.push(bia(a.caller,
                            b))
                    } catch (h) { c.push("[exception trying to get caller]\n") }
                } else a ? c.push("[...long stack...]") : c.push("[end]"); return c.join("")
            }; cia = function (a) { var b = Error(); if (Error.captureStackTrace) Error.captureStackTrace(b, a || cia), b = String(b.stack); else { try { throw b; } catch (c) { b = c } b = (b = b.stack) ? String(b) : null } b || (b = bia(a || arguments.callee.caller, [])); return b }; xW = function (a) { return a instanceof $.je && a.constructor === $.je && a.f === $.ie ? a.b : "type_error:Const" };
            ...
            XW = function (a, b) {
                var c = new TW; $.Ld(c, "ready", c.kd, !1, c); if (c.$v) throw Error("[goog.net.IframeIo] Unable to send, already active."); var d = new $.NW(a); if (!UW) { UW = $.Oe("FORM"); UW.acceptCharset = "utf-8"; var e = UW.style; e.position = "absolute"; e.visibility = "hidden"; e.top = e.left = "-10px"; e.width = e.height = "10px"; e.overflow = "hidden"; window.document.body.appendChild(UW) } c.Sk = UW; b && Iia(c.Sk, b); c.Sk.action = d.toString(); c.Sk.method = "POST"; c.$v = !0; c.$F = !1; c.FA = c.Br + "_" + (c.Uha++).toString(36); c.ul = $.Be(c.Sk).sc("IFRAME",
                    { name: c.FA, id: c.FA }); $.id && 7 > Number($.cd) && (c.ul.src = 'javascript:""'); d = c.ul.style; d.visibility = "hidden"; d.width = d.height = "10px"; d.display = "none"; $.wd ? d.marginTop = d.marginLeft = "-10px" : (d.position = "absolute", d.top = d.left = "-10px"); if ($.id && !$.dd("11")) { c.Sk.target = c.FA || ""; $.Be(c.Sk).b.body.appendChild(c.ul); $.Ld(c.ul, "readystatechange", c.FW, !1, c); try { c.b = !1, c.Sk.submit() } catch (Lb) { $.Zd(c.ul, "readystatechange", c.FW, !1, c), VW(c) } } else {
                        $.Be(c.Sk).b.body.appendChild(c.ul); d = c.FA + "_inner"; e = LW(c.ul); if (window.document.baseURI) {
                            var f =
                        ...
                        } else f = $.sc(d), $.ke("Short HTML snippet, input escaped, for performance"), f = $.te('<body><iframe id="' + f + '" name="' + f + '"></iframe>', null); $.xd && !$.wd ? e.documentElement.innerHTML = IW(f) : e.write(IW(f)); $.Ld(e.getElementById(d), "load", c.aO, !1, c); var h = KW("TEXTAREA", c.Sk); f = 0; for (var k = h.length; f < k; f++) {
                            var l =
                                h[f].value; $.nf(h[f]) != l && ($.ef(h[f], l), h[f].value = l)
                        } h = e.importNode(c.Sk, !0); h.target = d; h.action = c.Sk.action; e.body.appendChild(h); l = KW("SELECT", c.Sk); var m = KW("SELECT", h); f = 0; for (k = l.length; f < k; f++)for (var p = KW("OPTION", l[f]), q = KW("OPTION", m[f]), r = 0, t = p.length; r < t; r++)q[r].selected = p[r].selected; l = KW("INPUT", c.Sk); m = KW("INPUT", h); f = 0; for (k = l.length; f < k; f++)if ("file" == l[f].type && l[f].value != m[f].value) { c.Sk.target = d; h = c.Sk; break } try { c.b = !1, h.submit(), e.close(), $.hd && $.Fj(c.l6, 250, c) } catch (Lb) {
                            try {
                                var u =
                                    $.ha("window.location.href"); if ($.z(Lb)) var v = { message: Lb, name: "Unknown error", lineNumber: "Not available", fileName: u, stack: "Not available" }; else {
                                        f = !1; try { var w = Lb.lineNumber || Lb.line || "Not available" } catch (Tb) { w = "Not available", f = !0 } try { var x = Lb.fileName || Lb.filename || Lb.sourceURL || $.fa.$googDebugFname || u } catch (Tb) { x = "Not available", f = !0 } v = !f && Lb.lineNumber && Lb.fileName && Lb.stack && Lb.message && Lb.name ? Lb : {
                                            message: Lb.message || "Not available", name: Lb.name || "UnknownError", lineNumber: w, fileName: x, stack: Lb.stack ||
                                                "Not available"
                                        }
                                    } var y = v.fileName; null != y || (y = ""); if (/^https?:\/\//i.test(y)) { var B = HW(y); $.ke("view-source scheme plus HTTP/HTTPS URL"); var G = "view-source:" + GW(B); var D = $.ne(G) } else { var K = $.ke("sanitizedviewsrc"); D = $.ne(xW(K)) } var P = JW("Message: " + v.message + "\nUrl: "); u = { href: D, target: "_new" }; var R = v.fileName; if (!Jia.test("a")) throw Error("Invalid tag name <a>."); if ("A" in Kia) throw Error("Tag name <a> is not allowed for SafeHtml."); w = null; x = ""; if (u) for (var T in u) {
                                        if (!Jia.test(T)) throw Error('Invalid attribute name "' +
                                            T + '".'); var xa = u[T]; if (null != xa) {
                                                D = x; y = T; B = xa; if (B instanceof $.je) B = xW(B); else if ("style" == y.toLowerCase()) B = nia(B); else { if (/^on/i.test(y)) throw Error('Attribute "' + y + '" requires goog.string.Const value, "' + B + '" given.'); if (y.toLowerCase() in Lia) if (B instanceof FW) B = fia(B); else if (B instanceof $.me) B = GW(B); else if ($.z(B)) B = HW(B).au(); else throw Error('Attribute "' + y + '" on tag "a" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + B + '" given.'); } B.zy && (B = B.au()); var ta = y + '="' + $.sc(String(B)) +
                                                    '"'; x = D + (" " + ta)
                                            }
                                    } var Qa = "<a" + x; null != R ? $.A(R) || (R = [R]) : R = []; if (!0 === Mia.a) Qa += ">"; else { var xb = oia(R); Qa += ">" + IW(xb) + "</a>"; w = xb.b() } var qc = u && u.dir; qc && (/^(ltr|rtl|auto)$/i.test(qc) ? w = 0 : w = null); var ib = $.te(Qa, w); var Sb = oia(P, ib, JW("\nLine: " + v.lineNumber + "\n\nBrowser stack:\n" + v.stack + "-> [end]\n\nJS stack traversal:\n" + cia(void 0) + "-> "))
                            } catch (Tb) { Sb = JW("Exception trying to expose exception! You win, we lose. " + Tb) } IW(Sb); $.Zd(e.getElementById(d), "load", c.aO, !1, c); e.close(); VW(c)
                        }
                    } WW(c)
            };
            ...
            Wia = function (a, b, c, d, e) {
                if (a.b) throw Error("[goog.net.XhrIo] Object is active with another request=" + a.ma + "; newUri=" + b); c = c ? c.toUpperCase() : "GET"; a.ma = b; a.D = ""; a.i = 0; a.ea = !1; a.f = !0; a.b = a.ba ? Tia(a.ba) : Tia(bX); a.aa = a.ba ? Ria(a.ba) : Ria(bX); a.b.onreadystatechange = (0, $.pa)(a.o4, a); try { a.Ba = !0, a.b.open(c, String(b), !0), a.Ba = !1 } catch (h) { a.Jv(5, h); return } b = d || ""; var f = a.headers.clone(); e && uia(e, function (a, b) { f.set(b, a) }); e = $.ya(f.Wt(), Xia); d = $.fa.FormData && b instanceof $.fa.FormData; !$.Aa(Yia, c) || e || d || f.set("Content-Type",
                    "application/x-www-form-urlencoded;charset=utf-8"); f.forEach(function (a, b) { this.b.setRequestHeader(b, a) }, a); a.Ya && (a.b.responseType = a.Ya); "withCredentials" in a.b && a.b.withCredentials !== a.Ja && (a.b.withCredentials = a.Ja); try { Zia(a), 0 < a.G && (a.Ha = $ia(a.b), a.Ha ? (a.b.timeout = a.G, a.b.ontimeout = (0, $.pa)(a.r6, a)) : a.P = $.Fj(a.r6, a.G, a)), a.K = !0, a.b.send(b), a.K = !1 } catch (h) { a.Jv(5, h) }
            }; $ia = function (a) { return $.id && $.dd(9) && $.ea(a.timeout) && $.n(a.ontimeout) }; Xia = function (a) { return "content-type" == a.toLowerCase() };
            ...
            oX = function (a, b, c, d, e, f, h) {
                var k = null; $.n(c) ? $.ea(c) ? (b["pdf-width"] = c, b["pdf-height"] = $.ea(d) ? d : a.height()) : $.z(c) ? (b["pdf-size"] = c || "a4", b.landscape = !!d, k = nX[b["pdf-size"]], b.landscape && (k = { width: k.height, height: k.width })) : (b["pdf-width"] = a.width(), b["pdf-height"] = a.height()) : (b["pdf-width"] = a.width(), b["pdf-height"] = a.height()); $.n(e) && (b["pdf-x"] = e); $.n(f) && (b["pdf-y"] = f); $.n(h) && (b["file-name"] = h); k ? (c = k.width, k = k.height, d = a.width(), h = a.height(), k = c < k ? [c, c / d * h] : c > k ? [k / h * d, k] : [c, k], k[0] -= e || 0,
                    k[1] -= f || 0, a = a.Lq(k[0], k[1])) : a = a.Lq(b["pdf-width"], b["pdf-height"]); b.data = a; b.dataType = "svg"; b.responseType = "file"
            }; pX = function (a, b, c, d, e) { if ("svg" == $.lk) { var f = {}; kX(a, f, b, c, d, e); XW(iX + "/png", f) } else (0, window.alert)($.kd(15)) }; qX = function (a, b, c, d, e, f) { if ("svg" == $.lk) { var h = {}; lX(a, h, b, c, d, e, f); XW(iX + "/jpg", h) } else (0, window.alert)($.kd(15)) }; rX = function (a, b, c, d, e, f) { if ("svg" == $.lk) { var h = {}; oX(a, h, b, c, d, e, f); XW(iX + "/pdf", h) } else (0, window.alert)($.kd(15)) };
            ...
            fja = function (a) {
                var b = uX, c = $.fa.anychart.exports; if (c.Z2) return ria(); var d = b.ea, e = c.hc(a, "clientside").path; e += $.hc(e, "/") ? "" : "/"; a = []; for (var f = 0; f < d.length; f++)b = new $.qj(function (a, b) { var c = e + d[f], h = $.Te(window.document, "script"); h.setAttribute("src", c); h.onload = h.onreadystatechange = function () { $.hl("info", "Loaded external exporting script " + c); a() }; h.onerror = function () { $.hl("warn", "Failed tp load external script " + c); b() }; $.Pp.head.appendChild(h) }), a.push(b); return qia(a).then(function () {
                    c.Z2 =
                        !0
                })
            }; vX = function (a, b, c) { if ($.C(c)) { var d = {}; $.Gc(c, function (a, b) { $.n(a) && (d[b] = a) }); $.Nc(d) || (a[b] = d) } else $.n(c) && (a[b] = c) }; gja = function (a, b, c, d) { Xha(fja(a).then(function () { var a = $.fa.XLSX, d = a.utils, h = $.Um().fC(b), k = d.book_new(); h = d.aoa_to_sheet(h); d.book_append_sheet(k, h, "data"); a = a.write(k, { type: "array" }); wX(new window.Blob([a], { type: xX.xlsx }), c, "xlsx") }), function () { d() }) };
            hja = function (a, b, c, d) {
                var e = c.paperSize, f = c.landscape, h = c.x || 0, k = c.y || 0, l = c.filename || "anychart"; l += ".pdf"; try {
                    if ($.n(e) || $.n(f)) { var m = rW(e, f); if ($.z(e)) { var p = nX[e].width; var q = nX[e].height; if (f && q > p || !f && q < p) p = [q, q = p][0] } else p = (0, window.parseFloat)(m.width), q = (0, window.parseFloat)(m.height); var r = new $.fa.jsPDF(f ? "l" : "p", "pt", e || [p, q]); $.z(b) ? r.addImage(b, "png", h, k, p, q) : $.fa.svg2pdf(b, r, { xOffset: h, yOffset: k, scale: 1 }) } else {
                    ...
                    try {
                        if (l.msToBlob && m.drawSvg) {
                            m.drawSvg(r, 0, 0, d, e); var a = l.toDataURL(k,
                                q)
                        } else m.drawImage(p, 0, 0, d, e), a = l.toDataURL(k, q); f(a); $.Ye(l); yW().revokeObjectURL(t)
                    } catch (v) { h(b) }
                }; p.src = t
            };
            ...
            var gia = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i, jia = /^[-,."'%_!# a-zA-Z0-9]+$/, Jia = /^[a-zA-Z0-9-]+$/, Lia = { action: !0, cite: !0, data: !0, formaction: !0, href: !0, manifest: !0, poster: !0, src: !0 }, Kia = { APPLET: !0, BASE: !0, EMBED: !0, IFRAME: !0, LINK: !0, MATH: !0, META: !0, OBJECT: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 }, nX = {
            ...
            $.g.print = function (a, b) {
                if ($.n(a) || $.n(b)) { var c = rW(a, b, "us-letter"), d = Zha().contentWindow.document; sW("html, body {height: 100%; overflow: hidden}", d); var e = $.Oe("DIV"); $.wf(e, { width: c.width, height: c.height }); d.body.appendChild(e); c = this.width(); d = this.height(); var f = $.Yf(e); this.resize(f.width, f.height); f = this.ia(); "svg" == f.tagName && f.cloneNode ? (f = f.cloneNode(!0), e.appendChild(f)) : $.mk(e).data(this.data()); this.resize(c, d) } else e = Zha().contentWindow.document, d = this.ia(), "svg" == d.tagName ? d.cloneNode ?
            ...
            uX.DE = function (a, b, c, d, e, f) {
                var h = uX.hc(a, "facebook"), k = MW({ caption: c, link: d, name: e, description: f }, c, h), l = $.ll.open("", "_blank", "scrollbars=yes, width=550, height=550, top=" + Number(window.screen.height / 2 - 275) + ", left=" + Number(window.screen.width / 2 - 275)); uX.Fu(a, b, function (a) {
            ...
            uX.GE = function (a, b) {
                var c = uX.hc(a, "twitter"), d = Number(window.screen.width / 2 - 300), e = Number(window.screen.height / 2 - 260); var f = $.De(window.document, "INPUT", "ac-share-twitter-data-input", void 0); if (0 < f.length) { var h = f[0]; f = $.De(window.document, "FORM", "ac-share-twitter-form", void 0)[0] } else {
                    f = $.Te(window.document, "FORM"); $.Rj(f, "ac-share-twitter-form"); f.target = "Map"; f.method = "POST"; f.action = c.url; h = $.Te(window.document, "INPUT"); $.Rj(h, "ac-share-twitter-data-input"); h.type = "hidden"; h.name = "data"; var k =
                        $.Te(window.document, "INPUT"); k.type = "hidden"; k.name = "dataType"; k.value = "svg"; f.appendChild(h); f.appendChild(k); KW("BODY")[0].appendChild(f)
                } $.n(f) && $.n(h) && (h.value = uX.Lq(a, b, c.width, c.height), $.ll.open("", "Map", "status=0,title=0,height=520,width=600,scrollbars=1, width=600, height=520, top=" + e + ", left=" + d) && f.submit())
            };
            ...
            $.F("anychart.exports.server", uX.ma);
        }).call(this, $)
    }
